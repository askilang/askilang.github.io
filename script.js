...
function showDiv() { setTimeout(tombol, 1200); document.getElementById("bq").style = "opacity:1;visibility:visible;margin-top:0"; document.getElementById('bodyblur').style = "opacity:1;"; document.getElementById('Content').style = "opacity:1;margin-top:1vh;animation:kont 3s infinite;"; document.getElementById("katakata").innerHTML = kata1; }
...
async function menuju() { if (fungsi == 2) { await swals.fire('Enjoy the surprise, cil&#128521'); play(); window.location.href = 'kue.html'; } }
